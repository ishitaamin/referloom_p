// referloom_frontend/app/(roles)/student/_layout.js
...
export default function StudentLayout() {
  return (
    <Tabs screenOptions={{ 
      ...
      {/* 1. BOTTOM TABS (Visible in the bar) */}
      <Tabs.Screen 
        name="index" 
      ...
      {/* ✅ ADDED: The new Offers tab with a bell icon */}
      <Tabs.Screen 
        name="OffersScreen" 
        options={{ title: 'Offers', tabBarIcon: ({ color }) => <Feather name="bell" size={24} color={color} /> }} 
      />
      ...
      {/* 2. STACK SCREENS (Hidden from Bottom Tab Bar but still accessible via router.push) */}
      ...
      {/* Don't forget the Add Experience screen we built earlier! */}
